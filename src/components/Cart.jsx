...
const Cart = () => {
    const {currentColor, setThemeCart} = useStateContext();

    return (
        <div className="bg-half-transparent w-full fixed nav-item top-0 right-0">
            <div className="float-right h-screen duration-1000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-8">
                <div className="flex justify-between items-center">
                    <p className="font-semi-bold text-lg">Shopping Cart</p>
                    <button type="button"
                            onClick={() => setThemeCart(false)}
                        ...
                        <div>
                            <div className="flex items-center  leading-8 gap-5 border-b-1 border-color dark:border-gray-600 p-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 text-sm font-semi-bold">{item.category}</p>
                                    <div className="flex gap-4 mt-2 items-center">
                                        <p className="font-semi-bold text-lg">{item.price}</p>
                ...
                <div className="mt-3 mb-3">
                    <div className="flex justify-between items-center">
                        ...
                        <p className="font-semi-bold">$890</p>
                    </div>
